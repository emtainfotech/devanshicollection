...
import { LayoutDashboard, Package, Grid3X3, Image, ShoppingCart, Tag, LogOut, ChevronLeft, MessageSquare, Settings, Bot, FileText, CreditCard, AlertTriangle, RotateCcw } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { label: 'Returns & Refunds', href: '/admin/order-requests', icon: RotateCcw },
  { label: 'Customer Queries', href: '/admin/customer-care', icon: MessageSquare },
