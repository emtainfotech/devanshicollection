      ...
      <nav className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
              ...
              <nav className="mt-8 space-y-1">
                {categories.map((cat) => (
                  <Link
                    ...
                    className="block py-3 px-4 text-sm font-body hover:bg-accent rounded-md transition-colors"
                  >
                    {cat.name}
                  </Link>
                ))}
                <div className="border-t border-border my-4" />
                <Link to="/about" className="block py-3 px-4 text-sm font-body hover:bg-accent rounded-md">
                  About Us
                </Link>
                <Link to="/contact" className="block py-3 px-4 text-sm font-body hover:bg-accent rounded-md">
                  Contact
                </Link>
              </nav>
            </SheetContent>
          ...
          <div className="flex items-center gap-1">
            ...
            <Link
              to="/wishlist"
              className="p-2.5 hover:bg-accent rounded-full transition-colors active:scale-95 relative"
              aria-label="Wishlist"
            >
